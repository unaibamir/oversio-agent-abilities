...
function aafm_ability_disclosures(): array {
	return array(
		...
		'aafm/yoast-get-post'              => __( "Reads a post's Yoast SEO fields from its post meta: title, description, focus keyword, canonical URL, the social tags, and the three robots directives (noindex, nofollow, and the advanced list). Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/yoast-get-head'              => __( 'Reads the rendered Yoast SEO head markup for a post when it is available, and an empty string when it is not. Requires the edit-posts capability and edit access to that post.', 'agent-abilities-for-mcp' ),
		'aafm/rankmath-get-post'           => __( "Reads a post's Rank Math SEO fields from its post meta: title, description, focus keyword, canonical URL, the social tags, and the robots directives. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/rankmath-get-schema'         => __( "Reads a post's structured-data schema of a given type (for example Article or FAQPage) from Rank Math. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/rankmath-get-head'           => __( 'Reads the rendered Rank Math SEO head markup for a post when it is available, and an empty string when it is not. Requires the edit-posts capability and edit access to that post.', 'agent-abilities-for-mcp' ),
		'aafm/aioseo-get-post'             => __( "Reads a post's SEO fields from All in One SEO's own data store, not post meta: title, description, canonical URL, the social tags, and the noindex and nofollow flags. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/aioseo-get-head'             => __( 'Reads the rendered All in One SEO head markup for a post when it is available, and an empty string when it is not. Requires the edit-posts capability and edit access to that post.', 'agent-abilities-for-mcp' ),
		...
		'aafm/yoast-update-post'           => __( "Writes a post's Yoast SEO fields to its post meta. URL fields are sanitized as URLs, and the robots directives are checked against what Yoast accepts before they are saved. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/rankmath-update-post'        => __( "Writes a post's Rank Math SEO fields to its post meta. URL fields are sanitized as URLs, and robots is stored in the directive-array form Rank Math expects. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/rankmath-update-schema'      => __( "Writes a post's structured-data schema of a given type to Rank Math. The whole object is sanitized, top to bottom. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		'aafm/aioseo-update-post'          => __( "Writes a post's SEO fields through All in One SEO's own data store, not post meta. URL fields are sanitized as URLs. Requires edit access to that post.", 'agent-abilities-for-mcp' ),
		...
		'aafm/wc-get-sales-report'         => __( 'Returns a sales summary (total sales, order count, net sales, average order value) for a date range you specify. Queries completed and processing orders only. Defaults to the current calendar month. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
		'aafm/wc-get-top-sellers-report'   => __( 'Returns the top-selling products for a period (week, month, or year) ordered by quantity sold. Returns product id, name, and quantity only — no pricing data. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
		'aafm/wc-count-orders'             => __( 'Returns order counts broken down by WooCommerce status (pending, processing, on-hold, completed, cancelled, refunded, failed) and a grand total. Read-only. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
		'aafm/wc-count-products'           => __( 'Returns product counts broken down by post status (publish, draft, private, pending, trash) and a total of non-trashed products. Read-only. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
		'aafm/wc-count-customers'          => __( 'Returns the total count of registered users on the site. Read-only. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
		...
		'aafm/wc-count-coupons'            => __( 'Returns coupon counts broken down by post status (publish, draft, private, pending, trash) and a total of active (non-trash) coupons. Read-only. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
